(function () {
  ...
  if (!document.querySelector('style[data-home-hero-final-refinement]')) {
    ...
    finalStyle.textContent = [
      ...
      // Soften the boundary between the Hero and the practice section without changing layout.
      'body.home-hero-redesign #hanh-trinh {',
      '  position: relative !important;',
      '  z-index: 3 !important;',
      '  isolation: isolate;',
      '  background: linear-gradient(180deg, #f8faf6 0, #f4f7f2 92px, #eef3eb 100%) !important;',
      '}',
      'body.home-hero-redesign #hanh-trinh::before {',
      '  content: "" !important;',
      ...
      '  background: linear-gradient(180deg, rgba(248,250,246,0) 0%, rgba(248,250,246,0.46) 34%, rgba(248,250,246,0.88) 72%, #f8faf6 100%) !important;',
      '  border-radius: 50% 50% 0 0 / 100% 100% 0 0 !important;',
      '  pointer-events: none !important;',
      '  z-index: 0 !important;',
      '}',
      'body.home-hero-redesign #hanh-trinh > .container { position: relative !important; z-index: 1 !important; }',
      '@media (max-width: 1024px) {',
      '  body.home-hero-redesign #hanh-trinh::before { top: -52px !important; height: 54px !important; }',
      '}',
      '@media (max-width: 768px) {',
      '  body.home-hero-redesign #hanh-trinh::before { top: -38px !important; height: 40px !important; left: -8% !important; right: -8% !important; }',
      '  body.home-hero-redesign #hanh-trinh { background: linear-gradient(180deg, #f8faf6 0, #f4f7f2 64px, #eef3eb 100%) !important; }',
      '}',
