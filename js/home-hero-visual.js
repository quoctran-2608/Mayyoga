(function () {
  ...
  if (!document.querySelector('style[data-home-hero-final-refinement]')) {
    ...
    finalStyle.textContent = [
      ...
      // Subtle independent floating motion. Preserve the badge scale used by the base design.
      '@keyframes heroBadgeFloatTop {',
      '  0%, 100% { transform: scale(0.72) translate3d(0, 0, 0); }',
      '  50% { transform: scale(0.72) translate3d(0, -5px, 0); }',
      '}',
      '@keyframes heroBadgeFloatTrust {',
      '  0%, 100% { transform: scale(0.72) translate3d(0, 0, 0); }',
      '  48% { transform: scale(0.72) translate3d(0, -4px, 0); }',
      '  72% { transform: scale(0.72) translate3d(0, 1px, 0); }',
      '}',
      '@media (min-width: 769px) and (prefers-reduced-motion: no-preference) {',
      '  body.home-hero-redesign .hero-image .floating-card.card-1 {',
      '    animation: heroBadgeFloatTop 5.2s ease-in-out infinite !important;',
      '    will-change: transform;',
      '  }',
      '  body.home-hero-redesign .hero-image .hero-trust-card {',
      '    animation: heroBadgeFloatTrust 5.8s ease-in-out -2.1s infinite !important;',
      '    will-change: transform;',
      '  }',
      '}',
