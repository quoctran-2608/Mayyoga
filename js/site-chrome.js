// ===== Mây Yoga — Shared Footer + Floating Contact =====
// Canonical site-wide chrome. The homepage/index design is the source of truth.
(function syncSiteChrome() {
  ...
  function ensureStandardStyles() {
    ...
    style.textContent = [
      ...
      'html body .footer .container{padding:0 16px !important;}',
      'html body .footer-grid-new{grid-template-columns:1fr !important;gap:32px !important;padding:40px 0 28px !important;}',
      'html body .footer-brand-col{margin:0 auto !important;}',
      'html body .footer-logo-img{height:54px !important;}',
      'html body .floating-contact{bottom:20px !important;right:16px !important;gap:12px !important;}',
      'html body .floating-contact a{width:44px !important;height:44px !important;}',
      'html body .floating-contact .fc-zalo svg{width:22px !important;height:22px !important;}',
      'html body .floating-contact .fc-whatsapp svg{width:24px !important;height:24px !important;}',
      'html body .floating-contact a::before{display:none !important;}',
      '}',
  ...
  function footerMarkup() {
    return [
      ...
      '      <a href="' + siteUrl('index.html') + '" class="footer-logo-link">',
      '        <img src="' + siteUrl('assets/images/logo.webp') + '" alt="Mây Yoga" class="footer-logo-img">',
      '      </a>',
