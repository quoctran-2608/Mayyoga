...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (mobileToggle) {
    ...
    // Close mobile menu on link click (but NOT on dropdown toggle clicks)
  ...
  // ===== Category card hover sound/haptic (optional) =====
  ...
  function renderRandomArticles() {
    ...
    picked.forEach(function(a) {
      html += '<div class="blog-card">' +
        '<div class="blog-image"><img src="' + a.img + '" alt="' + a.tag + '"></div>' +
        '<div class="blog-body">' +
        ...
        '<span>' + a.time + '</span>' +
        '<a href="' + a.url + '" class="read-more">Đọc tiếp →</a>' +
        '</div></div></div>';
    });
    grid.innerHTML = html;
  }
